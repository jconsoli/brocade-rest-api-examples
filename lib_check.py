...
imports = (
    ...
    {'d': ''},
    {'l': 'brcdapi.pyfos_auth', 'd': 'Required by brcdapi.brcdapi_rest.', 'r': '3.0.2'},
    {'l': 'brcdapi.brcdapi_rest', 'd': 'FOS RESTConf API driver.', 'r': '3.0.4'},
    ...
    {'l': 'brcddb.brcddb_zone', 'd': 'Required for most brcddb libraries', 'r': '3.0.3'},
    {'l': 'brcddb.classes.alert', 'd': 'Required for all brcddb libraries', 'r': '3.0.2'},
    {'l': 'brcddb.classes.chassis', 'd': 'Required for all brcddb libraries', 'r': '3.0.4'},
    {'l': 'brcddb.classes.fabric', 'd': 'Required for all brcddb libraries', 'r': '3.0.4'},
    {'l': 'brcddb.classes.iocp', 'd': 'Required for all brcddb libraries', 'r': '3.0.3'},
    {'l': 'brcddb.classes.login', 'd': 'Required for all brcddb libraries', 'r': '3.0.3'},
    {'l': 'brcddb.classes.port', 'd': 'Required for all brcddb libraries', 'r': '3.0.5'},
    {'l': 'brcddb.classes.project', 'd': 'Required for all brcddb libraries', 'r': '3.0.3'},
    {'l': 'brcddb.classes.switch', 'd': 'Required for all brcddb libraries', 'r': '3.0.4'},
    {'l': 'brcddb.classes.util', 'd': 'Required for all brcddb libraries', 'r': '3.0.5'},
    {'l': 'brcddb.classes.zone', 'd': 'Required for all brcddb libraries', 'r': '3.0.5'},
    ...
    {'l': 'brcddb.util.iocp', 'd': 'Required for most brcddb libraries', 'r': '3.0.6'},
    ...
    {'l': 'brcddb.util.search', 'd': 'Required for most brcddb libraries', 'r': '3.0.5'},
    {'l': 'brcddb.util.util', 'd': 'Required for most brcddb libraries', 'r': '3.1.1'},
    ...
    {'l': 'brcddb.report.iocp', 'd': 'Required for generating Excel reports', 'r': '3.0.4'},
