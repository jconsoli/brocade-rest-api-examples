...
_imports = (
    ...
    {'l': 'brcdapi.excel_util', 'd': 'Required by modules that read or write Excel workbooks', 'r': '1.0.2'},
    ...
    {'l': 'brcdapi.util', 'd': 'Utilities supporting the FOS RESTConf API driver.', 'r': '3.0.9'},
    ...
    {'l': 'brcddb.brcddb_bp', 'd': 'Required for the report.py application', 'r': '3.0.9'},
